...
class MockDataSeeder extends Seeder
{
    ...
    private function seedBogdan(array $categories): void
    {
        ...
        $user->profile()->updateOrCreate(
            ...
            [
                'name' => self::BOGDAN['name'],
                'phone' => self::BOGDAN['phone'],
                'country_phone_code' => self::BOGDAN['country_phone_code'],
                'country_phone_iso' => self::BOGDAN['country_phone_iso'],
    ...
    private function seedAuthor(array $data): User
    {
        ...
        $user->profile()->updateOrCreate(
            ...
            [
                ...
                'country_phone_iso' => $data['country_phone_iso'],
